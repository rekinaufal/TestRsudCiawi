...
Route::get('/movie-regist', [MovieRegistrationController::class, 'MovieRegistration'])->name('MovieRegistration');
Route::resource('movieRegistration', 'App\Http\Controllers\MovieRegistrationController');
// Route::get('/UpdateStatusMovie/{id}', [MovieRegistrationController::class, 'UpdateStatus'])->name('UpdateStatusMovie');
